...
SUPABASE_URL_INSTAGRAM = os.environ['SUPABASE_URL']
SUPABASE_KEY_INSTAGRAM = os.environ['SUPABASE_KEY']
VERIFY_TOKEN_INSTAGRAM = os.environ['VERIFY_TOKEN']
USERNAME_INSTAGRAM = os.environ['USERNAME']
INSTAGRAM_USER_ID = os.environ['INSTAGRAM_USER_ID']

print("SUPABASE_URL:", SUPABASE_URL_INSTAGRAM)
print("SUPABASE_KEY:", SUPABASE_KEY_INSTAGRAM)
print("VERIFY_TOKEN:", VERIFY_TOKEN_INSTAGRAM)
print("USERNAME:", USERNAME_INSTAGRAM)
